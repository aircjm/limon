...
public class AnkiCardServiceImpl extends ServiceImpl<AnkiCardMapper, AnkiCard> implements AnkiCardService {
    ...
    @Override
    public String exportCard(GetCardRequest request) {
    ...
    public void updateAllCard() {
        String memberId = systemConfigService.selectConfigByKey("trello.default.memberId");
