...
import com.aircjm.limon.business.card.domain.Task;
import com.aircjm.limon.business.card.domain.TaskAttachment;
import com.aircjm.limon.business.card.mapper.TaskMapper;
...
import com.aircjm.limon.framework.AliyunOssService;
import com.aircjm.limon.framework.MessageService;
...
public class TaskServiceImpl extends ServiceImpl<TaskMapper, Task> implements TaskService {
    ...
    public void noticeAdd() {
        ...
        if (Objects.isNull(one) && DateUtils.isWorkTime(now)) {
            // 消息通知
            emailService.sendNoticeMessage("hello", "world", "ceshi@gmail.com");
        }
    }
